...
function Education () {
  ...
  <div id="Wrapper" className="flex justify-between items-center w-full flex-col relative max-w-[1100px] gap-3 tracking-wide">
        ...
        <div id="Desc" className="w-fit text-lg md:text-[20px] text-center font-[600] text-slate-600 mb-10 tracking-wider " >My education has been a journey of self-discovery educational details are as follows.</div>
