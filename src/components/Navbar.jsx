...
function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center text-2xl bg-slate-950 h-20 lg:px-12 shadow-md shadow-purple-950">
      {/* Logo */}
      <Link to={"/"} > <span id="Logo" className=' text-[22px] font-semibold text-purple-500 hover:text-green-400 tracking-widest cursor-pointer  duration-300' >{"<AnasMalik/>"}</span></Link>
